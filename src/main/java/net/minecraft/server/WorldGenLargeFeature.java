...
{
  private static List e = java.util.Arrays.asList(new BiomeBase[] { BiomeBase.DESERT, BiomeBase.DESERT_HILLS, BiomeBase.JUNGLE, BiomeBase.JUNGLE_HILLS, BiomeBase.SWAMPLAND });
  private List f;
  private int g;
  private int h;
  ...
  protected boolean a(int i, int j) {
    ...
    int i1 = i / this.g;
    int j1 = j / this.g;
    Random random = this.c.A(i1, j1, this.c.spigotConfig.largeFeatureSeed);
