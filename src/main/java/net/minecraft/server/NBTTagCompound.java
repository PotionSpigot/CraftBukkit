...
public class NBTTagCompound extends NBTBase
{
  ...
  public byte getByte(String paramString) {
    try {
      if (!this.map.containsKey(paramString)) return 0;
  ...
  {
    try {
      if (!this.map.containsKey(paramString)) return 0L;
  ...
  {
    try {
      if (!this.map.containsKey(paramString)) return 0.0F;
  ...
  {
    try {
      if (!this.map.containsKey(paramString)) return 0.0D;
  ...
  {
    try {
      if (!this.map.containsKey(paramString)) return "";
  ...
  {
    try {
      if (!this.map.containsKey(paramString)) return new byte[0];
  ...
  public int[] getIntArray(String paramString) {
    try {
      if (!this.map.containsKey(paramString)) return new int[0];
  ...
  public NBTTagCompound getCompound(String paramString) {
    try {
      if (!this.map.containsKey(paramString)) return new NBTTagCompound();
  ...
  public NBTTagList getList(String paramString, int paramInt) {
    try {
      if (b(paramString) != 9) return new NBTTagList();
