  ...
  extends WorldGenBase
{
            ...
            for (int i7 = i3; (i5 == 0) && (i7 < i4); i7++) {
              for (int i8 = i2 + 1; (i5 == 0) && (i8 >= i1 - 1); i8--) {
                ...
                if ((i8 >= 0) && (i8 < 128))
                {
                  ...
                  if ((localBlock1 == Blocks.LAVA) || (localBlock1 == Blocks.STATIONARY_LAVA)) {
                    i5 = 1;
                  }
              ...
              for (i9 = i3; i9 < i4; i9++) {
                ...
                for (int i11 = i2 - 1; i11 >= i1; i11--) {
                  ...
                  if ((d11 > -0.7D) && (d9 * d9 + d11 * d11 + d10 * d10 < 1.0D)) {
                    ...
                    if ((localBlock2 == Blocks.NETHERRACK) || (localBlock2 == Blocks.DIRT) || (localBlock2 == Blocks.GRASS)) {
  ...
  protected void a(World paramWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Block[] paramArrayOfBlock) { int i = this.b.nextInt(this.b.nextInt(this.b.nextInt(10) + 1) + 1);
    if (this.b.nextInt(5) != 0) { i = 0;
    }
    for (int j = 0; j < i; j++) {
      double d1 = paramInt1 * 16 + this.b.nextInt(16);
      double d2 = this.b.nextInt(128);
      ...
      for (int m = 0; m < k; m++)
      {
        ...
        a(this.b.nextLong(), paramInt3, paramInt4, paramArrayOfBlock, d1, d2, d3, f3 * 2.0F, f1, f2, 0, 0, 0.5D);
      }
    }
  }
}
