...
public class BlockPiston extends Block
{
  ...
  private boolean a(World world, int i, int j, int k, int l) {
    return world.isBlockFacePowered(i - 1, j + 1, k, 4) ? true : world.isBlockFacePowered(i, j + 1, k + 1, 3) ? true : world.isBlockFacePowered(i, j + 1, k - 1, 2) ? true : world.isBlockFacePowered(i, j + 2, k, 1) ? true : world.isBlockFacePowered(i, j, k, 0) ? true : (l != 4) && (world.isBlockFacePowered(i - 1, j, k, 4)) ? true : (l != 5) && (world.isBlockFacePowered(i + 1, j, k, 5)) ? true : (l != 3) && (world.isBlockFacePowered(i, j, k + 1, 3)) ? true : (l != 2) && (world.isBlockFacePowered(i, j, k - 1, 2)) ? true : (l != 1) && (world.isBlockFacePowered(i, j + 1, k, 1)) ? true : (l != 0) && (world.isBlockFacePowered(i, j - 1, k, 0)) ? true : world.isBlockFacePowered(i + 1, j + 1, k, 5);
  }
  ...
  public static int b(int i) {
    if ((i & 0x7) >= Facing.OPPOSITE_FACING.length) return 7;
    return i & 0x7;
  }
  ...
  private boolean i(World world, int i, int j, int k, int l)
  {
    ...
    for (Block[] ablock = new Block[13]; (i1 != i) || (j1 != j) || (k1 != k); k1 = j3) {
      int l2 = i1 - Facing.b[l];
      int i3 = j1 - Facing.c[l];
      j3 = k1 - Facing.d[l];
