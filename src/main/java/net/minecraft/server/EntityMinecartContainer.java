...
public abstract class EntityMinecartContainer extends EntityMinecartAbstract implements IInventory
{
    ...
    for (int i = 0; i < getSize(); i++) {
      ...
      if (itemstack != null) {
        ...
        while (itemstack.count > 0) {
          ...
          itemstack.count -= j;
          EntityItem entityitem = new EntityItem(this.world, this.locX + f, this.locY + f1, this.locZ + f2, new ItemStack(itemstack.getItem(), j, itemstack.getData()));
          float f3 = 0.05F;
  ...
  public void b(int i)
  {
    for (HumanEntity human : new ArrayList(this.transaction))
    {
