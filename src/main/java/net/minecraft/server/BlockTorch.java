...
public class BlockTorch extends Block
{
  ...
  private boolean m(World world, int i, int j, int k) {
    if (World.a(world, i, j, k)) {
      return true;
    }
    Block block = world.getType(i, j, k);
    

    return (block == Blocks.FENCE) || (block == Blocks.NETHER_FENCE) || (block == Blocks.GLASS) || (block == Blocks.STAINED_GLASS) || (block == Blocks.COBBLE_WALL);
  }
  
  public boolean canPlace(World world, int i, int j, int k)
  {
    return world.c(i, j, k + 1, true) ? true : world.c(i, j, k - 1, true) ? true : world.c(i + 1, j, k, true) ? true : world.c(i - 1, j, k, true) ? true : m(world, i, j - 1, k);
  }
  
  public int getPlacedData(World world, int i, int j, int k, int l, float f, float f1, float f2, int i1) {
    int j1 = i1;
    
    if ((l == 1) && (m(world, i, j - 1, k))) {
      j1 = 5;
    }
