...
public class PathfinderGoalMeleeAttack extends PathfinderGoal
{
  ...
  public boolean a() {
    ...
    if (!entityliving.isAlive())
      return false;
    if ((this.g != null) && (!this.g.isAssignableFrom(entityliving.getClass()))) {
      return false;
    }
  ...
  public boolean b()
  {
    ...
    if ((this.b.getGoalTarget() == null) || ((this.b.getGoalTarget() != null) && (!this.b.getGoalTarget().isAlive()))) {
      org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callEntityTargetEvent(this.b, null, reason);
    }
    

    return !this.e ? false : !this.b.getNavigation().g() ? true : !entityliving.isAlive() ? false : entityliving == null ? false : this.b.b(MathHelper.floor(entityliving.locX), MathHelper.floor(entityliving.locY), MathHelper.floor(entityliving.locZ));
  }
