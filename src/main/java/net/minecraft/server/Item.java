...
public class Item
{
  ...
  public static void l() {
    ...
    while (iterator.hasNext()) {
      ...
      if (block == Blocks.WOOL) {
        object = new ItemCloth(Blocks.WOOL).b("cloth"); } else { Object object;
        if (block == Blocks.STAINED_HARDENED_CLAY) {
          object = new ItemCloth(Blocks.STAINED_HARDENED_CLAY).b("clayHardenedStained"); } else { Object object;
          if (block == Blocks.STAINED_GLASS) {
            object = new ItemCloth(Blocks.STAINED_GLASS).b("stainedGlass"); } else { Object object;
            if (block == Blocks.STAINED_GLASS_PANE) {
              object = new ItemCloth(Blocks.STAINED_GLASS_PANE).b("stainedGlassPane"); } else { Object object;
              if (block == Blocks.WOOL_CARPET) {
                object = new ItemCloth(Blocks.WOOL_CARPET).b("woolCarpet"); } else { Object object;
                if (block == Blocks.DIRT) {
                  object = new ItemMultiTexture(Blocks.DIRT, Blocks.DIRT, BlockDirt.a).b("dirt"); } else { Object object;
                  if (block == Blocks.SAND) {
                    object = new ItemMultiTexture(Blocks.SAND, Blocks.SAND, BlockSand.a).b("sand"); } else { Object object;
                    if (block == Blocks.LOG) {
                      object = new ItemMultiTexture(Blocks.LOG, Blocks.LOG, BlockLog1.M).b("log"); } else { Object object;
                      if (block == Blocks.LOG2) {
                        object = new ItemMultiTexture(Blocks.LOG2, Blocks.LOG2, BlockLog2.M).b("log"); } else { Object object;
                        if (block == Blocks.WOOD) {
                          object = new ItemMultiTexture(Blocks.WOOD, Blocks.WOOD, BlockWood.a).b("wood"); } else { Object object;
                          if (block == Blocks.MONSTER_EGGS) {
                            object = new ItemMultiTexture(Blocks.MONSTER_EGGS, Blocks.MONSTER_EGGS, BlockMonsterEggs.a).b("monsterStoneEgg"); } else { Object object;
                            if (block == Blocks.SMOOTH_BRICK) {
                              object = new ItemMultiTexture(Blocks.SMOOTH_BRICK, Blocks.SMOOTH_BRICK, BlockSmoothBrick.a).b("stonebricksmooth"); } else { Object object;
                              if (block == Blocks.SANDSTONE) {
                                object = new ItemMultiTexture(Blocks.SANDSTONE, Blocks.SANDSTONE, BlockSandStone.a).b("sandStone"); } else { Object object;
                                if (block == Blocks.QUARTZ_BLOCK) {
                                  object = new ItemMultiTexture(Blocks.QUARTZ_BLOCK, Blocks.QUARTZ_BLOCK, BlockQuartz.a).b("quartzBlock"); } else { Object object;
                                  if (block == Blocks.STEP) {
                                    object = new ItemStep(Blocks.STEP, Blocks.STEP, Blocks.DOUBLE_STEP, false).b("stoneSlab"); } else { Object object;
                                    if (block == Blocks.DOUBLE_STEP) {
                                      object = new ItemStep(Blocks.DOUBLE_STEP, Blocks.STEP, Blocks.DOUBLE_STEP, true).b("stoneSlab"); } else { Object object;
                                      if (block == Blocks.WOOD_STEP) {
                                        object = new ItemStep(Blocks.WOOD_STEP, Blocks.WOOD_STEP, Blocks.WOOD_DOUBLE_STEP, false).b("woodSlab"); } else { Object object;
                                        if (block == Blocks.WOOD_DOUBLE_STEP) {
                                          object = new ItemStep(Blocks.WOOD_DOUBLE_STEP, Blocks.WOOD_STEP, Blocks.WOOD_DOUBLE_STEP, true).b("woodSlab"); } else { Object object;
                                          if (block == Blocks.SAPLING) {
                                            object = new ItemMultiTexture(Blocks.SAPLING, Blocks.SAPLING, BlockSapling.a).b("sapling"); } else { Object object;
                                            if (block == Blocks.LEAVES) {
                                              object = new ItemLeaves(Blocks.LEAVES).b("leaves"); } else { Object object;
                                              if (block == Blocks.LEAVES2) {
                                                object = new ItemLeaves(Blocks.LEAVES2).b("leaves"); } else { Object object;
                                                if (block == Blocks.VINE) {
                                                  object = new ItemWithAuxData(Blocks.VINE, false); } else { Object object;
                                                  if (block == Blocks.LONG_GRASS) {
                                                    object = new ItemWithAuxData(Blocks.LONG_GRASS, true).a(new String[] { "shrub", "grass", "fern" }); } else { Object object;
                                                    if (block == Blocks.YELLOW_FLOWER) {
                                                      object = new ItemMultiTexture(Blocks.YELLOW_FLOWER, Blocks.YELLOW_FLOWER, BlockFlowers.b).b("flower"); } else { Object object;
                                                      if (block == Blocks.RED_ROSE) {
                                                        object = new ItemMultiTexture(Blocks.RED_ROSE, Blocks.RED_ROSE, BlockFlowers.a).b("rose"); } else { Object object;
                                                        if (block == Blocks.SNOW) {
                                                          object = new ItemSnow(Blocks.SNOW, Blocks.SNOW); } else { Object object;
                                                          if (block == Blocks.WATER_LILY) {
                                                            object = new ItemWaterLily(Blocks.WATER_LILY); } else { Object object;
                                                            if (block == Blocks.PISTON) {
                                                              object = new ItemPiston(Blocks.PISTON); } else { Object object;
                                                              if (block == Blocks.PISTON_STICKY) {
                                                                object = new ItemPiston(Blocks.PISTON_STICKY); } else { Object object;
                                                                if (block == Blocks.COBBLE_WALL) {
                                                                  object = new ItemMultiTexture(Blocks.COBBLE_WALL, Blocks.COBBLE_WALL, BlockCobbleWall.a).b("cobbleWall"); } else { Object object;
                                                                  if (block == Blocks.ANVIL) {
                                                                    object = new ItemAnvil(Blocks.ANVIL).b("anvil"); } else { Object object;
                                                                    if (block == Blocks.DOUBLE_PLANT) {
                                                                      object = new ItemTallPlant(Blocks.DOUBLE_PLANT, Blocks.DOUBLE_PLANT, BlockTallPlant.a).b("doublePlant");
                                                                    } else { Object object;
                                                                      if ((block == Blocks.MOB_SPAWNER) || (block == Blocks.BIG_MUSHROOM_1) || (block == Blocks.BIG_MUSHROOM_2)) {
  ...
  public String n(ItemStack itemstack) {
    return ("" + LocaleI18n.get(new StringBuilder().append(k(itemstack)).append(".name").toString())).trim();
  }
