  ...
  extends ByteBuf
{
  ...
  {
    return (i & 0xF0000000) == 0 ? 4 : (i & 0xFFE00000) == 0 ? 3 : (i & 0xC000) == 0 ? 2 : (i & 0xFFFFFF80) == 0 ? 1 : 5;
  }
  ...
  public void a(NBTTagCompound nbttagcompound)
  {
    ...
    else if (nbttagcompound == null)
    {
      ...
      NBTCompressedStreamTools.a(nbttagcompound, new DataOutputStream(out));
  ...
  public NBTTagCompound b() {
    ...
    readerIndex(index);
    return NBTCompressedStreamTools.a(new ByteBufInputStream(this.a), new NBTReadLimiter(2097152L));
  }
  ...
  public String c(int i) throws IOException {
    ...
    String s = new String(readBytes(j).array(), Charsets.UTF_8);
  ...
  {
    return ChatSerializer.a(c(32767));
  }
  
  public void d18(IChatBaseComponent ichatbasecomponent) throws IOException {
    a(ChatSerializer.a(ichatbasecomponent));
  }
  ...
  public <T extends Enum<T>> T a(Class<T> oclass) {
    return ((Enum[])(Enum[])oclass.getEnumConstants())[a()];
  }
