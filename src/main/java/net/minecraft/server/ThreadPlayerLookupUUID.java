...
class ThreadPlayerLookupUUID extends Thread
{
  ...
  public void run() {
    ...
    try
    {
      ...
      LoginListener.a(this.a, LoginListener.c(this.a).av().hasJoinedServer(new GameProfile((java.util.UUID)null, gameprofile.getName()), s));
    ...
    throws Exception
  {
    ...
    java.net.InetAddress address = ((InetSocketAddress)this.a.networkManager.getSocketAddress()).getAddress();
    java.util.UUID uniqueId = LoginListener.a(this.a).getId();
    final CraftServer server = LoginListener.c(this.a).server;
