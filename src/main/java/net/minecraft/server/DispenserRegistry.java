...
public class DispenserRegistry
{
  ...
  static void a() {
    ...
    DispenseBehaviorFilledBucket localDispenseBehaviorFilledBucket = new DispenseBehaviorFilledBucket();
    ...
    BlockDispenser.a.a(Items.LAVA_BUCKET, localDispenseBehaviorFilledBucket);
    BlockDispenser.a.a(Items.WATER_BUCKET, localDispenseBehaviorFilledBucket);
