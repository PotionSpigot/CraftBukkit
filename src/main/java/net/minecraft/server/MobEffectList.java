...
public class MobEffectList
{
  ...
  public void tick(EntityLiving entityliving, int i) {
    if (this.id == REGENERATION.id) {
      ...
      if (entityliving.getHealth() > 1.0F) {
        entityliving.damageEntity(CraftEventFactory.POISON, 1.0F);
      }
  ...
  public MobEffectList a(IAttribute iattribute, String s, double d0, int i) {
    AttributeModifier attributemodifier = new AttributeModifier(java.util.UUID.fromString(s), a(), d0, i);
  ...
  public void b(EntityLiving entityliving, AttributeMapBase attributemapbase, int i) {
    ...
    while (iterator.hasNext()) {
      ...
      if (attributeinstance != null) {
        ...
        attributeinstance.a(new AttributeModifier(attributemodifier.a(), a() + " " + i, a(i, attributemodifier), attributemodifier.c()));
      }
    }
  }
