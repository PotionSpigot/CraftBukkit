...
public class BiomeTheEndDecorator extends BiomeDecorator {
  ...
  public BiomeTheEndDecorator() { this.J = new WorldGenEnder(Blocks.WHITESTONE); }
  ...
  protected void a(BiomeBase biomebase)
  {
    ...
    if ((this.c == 0) && (this.d == 0)) {
      ...
      this.a.addEntity(entityenderdragon, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.CHUNK_GEN);
    }
  }
}
