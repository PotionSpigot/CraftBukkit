...
public class ItemWorldMap extends ItemWorldMapBase
{
  ...
  public WorldMap getSavedMap(ItemStack itemstack, World world) {
    ...
    WorldMap worldmap = (WorldMap)worldMain.a(WorldMap.class, s);
    
    if ((worldmap == null) && (!world.isStatic)) {
      itemstack.setData(worldMain.b("map"));
  ...
  public void a(World world, Entity entity, WorldMap worldmap)
  {
    if ((((WorldServer)world).dimension == worldmap.map) && ((entity instanceof EntityHuman))) {
      ...
      worldmaphumantracker.d += 1;
      
      for (int k1 = l - j1 + 1; k1 < l + j1; k1++) {
        if ((k1 & 0xF) == (worldmaphumantracker.d & 0xF)) {
          int l1 = 255;
          int i2 = 0;
          double d0 = 0.0D;
          ...
          for (int j2 = i1 - j1 - 1; j2 < i1 + j1; j2++) {
            if ((k1 >= 0) && (j2 >= -1) && (k1 < 128) && (j2 < 128)) {
              ...
              if (!chunk.isEmpty()) {
                ...
                MaterialMapColor materialmapcolor = (MaterialMapColor)net.minecraft.util.com.google.common.collect.Iterables.getFirst(net.minecraft.util.com.google.common.collect.Multisets.copyHighestCountFirst(hashmultiset), MaterialMapColor.b);
  ...
  public Packet c(ItemStack itemstack, World world, EntityHuman entityhuman) {
    byte[] abyte = getSavedMap(itemstack, world).getUpdatePacket(itemstack, world, entityhuman);
    
    return abyte == null ? null : new PacketPlayOutMap(itemstack.getData(), abyte, getSavedMap(itemstack, world).scale);
  }
