  ...
  extends WorldGenBase
{
  ...
  {
    a(paramLong, paramInt1, paramInt2, paramArrayOfBlock, paramDouble1, paramDouble2, paramDouble3, 1.0F + this.b.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
  }
  ...
  protected void a(long paramLong, int paramInt1, int paramInt2, Block[] paramArrayOfBlock, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2, float paramFloat3, int paramInt3, int paramInt4, double paramDouble4) {
    ...
    for (; 
      ...
      if ((i == 0) && (paramInt3 == j) && (paramFloat1 > 1.0F) && (paramInt4 > 0)) {
        a(localRandom.nextLong(), paramInt1, paramInt2, paramArrayOfBlock, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 - 1.5707964F, paramFloat3 / 3.0F, paramInt3, paramInt4, 1.0D);
        a(localRandom.nextLong(), paramInt1, paramInt2, paramArrayOfBlock, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 + 1.5707964F, paramFloat3 / 3.0F, paramInt3, paramInt4, 1.0D);
        return;
      }
          ...
          if (i5 == 0)
          {
            for (i6 = m; i6 < n; i6++) {
              ...
              for (i9 = i3; i9 < i4; i9++) {
                ...
                int i10 = (i6 * 16 + i9) * 256 + i2;
                int i11 = 0;
                if (d9 * d9 + d10 * d10 < 1.0D) {
                  for (int i12 = i2 - 1; i12 >= i1; i12--) {
                    double d11 = (i12 + 0.5D - paramDouble2) / d4;
                    if ((d11 > -0.7D) && (d9 * d9 + d11 * d11 + d10 * d10 < 1.0D)) {
                      Block localBlock2 = paramArrayOfBlock[i10];
                      if (localBlock2 == Blocks.GRASS) i11 = 1;
                      if ((localBlock2 == Blocks.STONE) || (localBlock2 == Blocks.DIRT) || (localBlock2 == Blocks.GRASS)) {
                        if (i12 < 10) {
                          paramArrayOfBlock[i10] = Blocks.STATIONARY_LAVA;
                        } else {
                          paramArrayOfBlock[i10] = null;
                          if ((i11 != 0) && (paramArrayOfBlock[(i10 - 1)] == Blocks.DIRT))
                            paramArrayOfBlock[(i10 - 1)] = this.c.getBiome(i6 + paramInt1 * 16, i9 + paramInt2 * 16).ai;
                        }
                      }
                    }
                    i10--;
  ...
  protected void a(World paramWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Block[] paramArrayOfBlock) { int i = this.b.nextInt(this.b.nextInt(this.b.nextInt(15) + 1) + 1);
    ...
    for (int j = 0; j < i; j++) {
      ...
      if (this.b.nextInt(4) == 0) {
        a(this.b.nextLong(), paramInt3, paramInt4, paramArrayOfBlock, d1, d2, d3);
        k += this.b.nextInt(4);
      }
      ...
      for (int m = 0; m < k; m++)
      {
        ...
        if (this.b.nextInt(10) == 0) { f3 *= (this.b.nextFloat() * this.b.nextFloat() * 3.0F + 1.0F);
        }
        a(this.b.nextLong(), paramInt3, paramInt4, paramArrayOfBlock, d1, d2, d3, f3, f1, f2, 0, 0, 1.0D);
      }
    }
  }
}
