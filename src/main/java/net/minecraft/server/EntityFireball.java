...
public abstract class EntityFireball extends Entity
{
  ...
  public void h() {
    if ((!this.world.isStatic) && (((this.shooter != null) && (this.shooter.dead)) || (!this.world.isLoaded((int)this.locX, (int)this.locY, (int)this.locZ)))) {
      ...
      for (this.pitch = ((float)(Math.atan2(f1, this.motY) * 180.0D / 3.1415927410125732D) - 90.0F); this.pitch - this.lastPitch < -180.0F; this.lastPitch -= 360.0F) {}
  ...
  public void b(NBTTagCompound nbttagcompound) {
    ...
    nbttagcompound.set("power", a(new double[] { this.dirX, this.dirY, this.dirZ }));
    
    nbttagcompound.set("direction", a(new double[] { this.motX, this.motY, this.motZ }));
  }
  ...
  public void a(NBTTagCompound nbttagcompound) {
    ...
    this.h = Block.getById(nbttagcompound.getByte("inTile") & 0xFF);
