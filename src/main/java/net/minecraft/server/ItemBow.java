...
public class ItemBow extends Item
{
  ...
  public void a(ItemStack itemstack, World world, EntityHuman entityhuman, int i) {
    ...
    if ((flag) || (entityhuman.inventory.b(Items.ARROW))) {
      ...
      if (k > 0) {
        entityarrow.b(entityarrow.e() + k * 0.5D + 0.5D);
      }
      ...
      org.bukkit.event.entity.EntityShootBowEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callEntityShootBowEvent(entityhuman, itemstack, entityarrow, f);
      if (event.isCancelled()) {
