  ...
  extends Enchantment
{
  ...
  public int a(int paramInt, DamageSource paramDamageSource)
  {
    ...
    if (this.a == 0) return MathHelper.d(f * 0.75F);
    if ((this.a == 1) && (paramDamageSource.o())) return MathHelper.d(f * 1.25F);
    if ((this.a == 2) && (paramDamageSource == DamageSource.FALL)) return MathHelper.d(f * 2.5F);
    if ((this.a == 3) && (paramDamageSource.isExplosion())) return MathHelper.d(f * 1.5F);
    if ((this.a == 4) && (paramDamageSource.a())) return MathHelper.d(f * 1.5F);
    return 0;
  }
  ...
  public static int a(Entity paramEntity, int paramInt) {
    int i = EnchantmentManager.getEnchantmentLevel(Enchantment.PROTECTION_FIRE.id, paramEntity.getEquipment());
  ...
  public static double a(Entity paramEntity, double paramDouble) {
    int i = EnchantmentManager.getEnchantmentLevel(Enchantment.PROTECTION_EXPLOSIONS.id, paramEntity.getEquipment());
