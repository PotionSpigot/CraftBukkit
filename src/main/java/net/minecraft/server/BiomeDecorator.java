...
public class BiomeDecorator
{
  ...
  protected void a(BiomeBase biomebase)
  {
    ...
    for (int i = 0; i < this.F; i++) {
      int j = this.c + this.b.nextInt(16) + 8;
      int k = this.d + this.b.nextInt(16) + 8;
    ...
    for (int j = 0; j < i; j++) {
      int k = this.c + this.b.nextInt(16) + 8;
      int l = this.d + this.b.nextInt(16) + 8;
      int i1 = this.a.getHighestBlockYAt(k, l);
    ...
    for (j = 0; j < this.y; j++) {
      int k = this.c + this.b.nextInt(16) + 8;
      int l = this.d + this.b.nextInt(16) + 8;
      int i1 = this.b.nextInt(this.a.getHighestBlockYAt(k, l) + 32);
    ...
    for (j = 0; j < this.z; j++) {
      int k = this.c + this.b.nextInt(16) + 8;
      int l = this.d + this.b.nextInt(16) + 8;
      int i1 = this.b.nextInt(getHighestBlockYAt(k, l) * 2);
    ...
    for (j = 0; j < this.w; j++) {
      ...
      for (int i1 = this.b.nextInt(getHighestBlockYAt(k, l) * 2); (i1 > 0) && (this.a.isEmpty(k, i1 - 1, l)); i1--) {}
    ...
    if (this.b.nextInt(4) == 0) {
      ...
      int k = this.d + this.b.nextInt(16) + 8;
      int l = this.b.nextInt(getHighestBlockYAt(j, k) * 2);
    ...
    if (this.I) {
      for (j = 0; j < 50; j++) {
        int k = this.c + this.b.nextInt(16) + 8;
        int l = this.b.nextInt(this.b.nextInt(248) + 8);
        int i1 = this.d + this.b.nextInt(16) + 8;
        new WorldGenLiquids(Blocks.WATER).generate(this.a, this.b, k, l, i1);
      }
      
      for (j = 0; j < 20; j++) {
        int k = this.c + this.b.nextInt(16) + 8;
        int l = this.b.nextInt(this.b.nextInt(this.b.nextInt(240) + 8) + 8);
        int i1 = this.d + this.b.nextInt(16) + 8;
