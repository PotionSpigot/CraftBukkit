  ...
  extends ScoreboardTeamBase
{
  ...
  public void setPrefix(String paramString) {
    if (paramString == null) throw new IllegalArgumentException("Prefix cannot be null");
    this.e = paramString;
    this.a.handleTeamChanged(this);
  }
  ...
  public void setSuffix(String paramString) {
    if (paramString == null) throw new IllegalArgumentException("Suffix cannot be null");
    this.f = paramString;
    this.a.handleTeamChanged(this);
  }
  ...
  {
    if (paramScoreboardTeamBase == null) return paramString;
  ...
  public int packOptionData() {
    ...
    if (allowFriendlyFire()) i |= 0x1;
    if (canSeeFriendlyInvisibles()) { i |= 0x2;
    }
    return i;
  }
}
