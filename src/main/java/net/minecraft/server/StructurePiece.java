...
public abstract class StructurePiece
{
  ...
  public void a(World paramWorld, NBTTagCompound paramNBTTagCompound)
  {
    if (paramNBTTagCompound.hasKey("BB")) {
      this.f = new StructureBoundingBox(paramNBTTagCompound.getIntArray("BB"));
    }
    this.g = paramNBTTagCompound.getInt("O");
    this.h = paramNBTTagCompound.getInt("GD");
  ...
  {
    int i = Math.max(this.f.a - 1, paramStructureBoundingBox.a);
    int j = Math.max(this.f.b - 1, paramStructureBoundingBox.b);
    int k = Math.max(this.f.c - 1, paramStructureBoundingBox.c);
    int m = Math.min(this.f.d + 1, paramStructureBoundingBox.d);
    int n = Math.min(this.f.e + 1, paramStructureBoundingBox.e);
    int i1 = Math.min(this.f.f + 1, paramStructureBoundingBox.f);
  ...
  protected int a(Block paramBlock, int paramInt)
  {
    ...
    else if ((paramBlock == Blocks.WOODEN_DOOR) || (paramBlock == Blocks.IRON_DOOR_BLOCK)) {
      if (this.g == 0) {
        if (paramInt == 0) {
          return 2;
        }
        ...
        if (this.g == 1)
        {
          ...
          return paramInt + 1 & 0x3; }
        if (this.g == 3)
        {



          return paramInt + 3 & 0x3; }
      }
    } else if ((paramBlock == Blocks.COBBLESTONE_STAIRS) || (paramBlock == Blocks.WOOD_STAIRS) || (paramBlock == Blocks.NETHER_BRICK_STAIRS) || (paramBlock == Blocks.STONE_STAIRS) || (paramBlock == Blocks.SANDSTONE_STAIRS)) {
      if (this.g == 0) {
        if (paramInt == 2) {
          return 3;
        }
    ...
    } else if (paramBlock == Blocks.LADDER) {
      if (this.g == 0) {
        if (paramInt == 2) {
          return 3;
        }
    ...
    else if (paramBlock == Blocks.STONE_BUTTON) {
      if (this.g == 0) {
        if (paramInt == 3) {
          return 4;
        }
    ...
    } else if ((paramBlock == Blocks.TRIPWIRE_SOURCE) || ((paramBlock instanceof BlockDirectional))) {
      if (this.g == 0) {
        if ((paramInt == 0) || (paramInt == 2)) {
          return Direction.f[paramInt];
        }
      } else if (this.g == 1) {
        if (paramInt == 2) {
          return 1;
    ...
    } else if ((paramBlock == Blocks.PISTON) || (paramBlock == Blocks.PISTON_STICKY) || (paramBlock == Blocks.LEVER) || (paramBlock == Blocks.DISPENSER)) {
      if (this.g == 0) {
        if ((paramInt == 2) || (paramInt == 3)) {
          return Facing.OPPOSITE_FACING[paramInt];
        }
      } else if (this.g == 1) {
        if (paramInt == 2) {
          return 4;
      ...
      for (int j = paramInt1; j <= paramInt4; j++) {
        for (int k = paramInt3; k <= paramInt6; k++)
        {
          if ((!paramBoolean) || (a(paramWorld, j, i, k, paramStructureBoundingBox).getMaterial() != Material.AIR))
          {
            ...
            if ((i == paramInt2) || (i == paramInt5) || (j == paramInt1) || (j == paramInt4) || (k == paramInt3) || (k == paramInt6)) {
              a(paramWorld, paramBlock1, paramInt7, j, i, k, paramStructureBoundingBox);
            } else {
              a(paramWorld, paramBlock2, paramInt8, j, i, k, paramStructureBoundingBox);
            }
          }
        }
      }
  ...
  protected boolean a(World paramWorld, StructureBoundingBox paramStructureBoundingBox, Random paramRandom, int paramInt1, int paramInt2, int paramInt3, StructurePieceTreasure[] paramArrayOfStructurePieceTreasure, int paramInt4)
  {
    ...
    if ((paramStructureBoundingBox.b(i, j, k)) && 
      (paramWorld.getType(i, j, k) != Blocks.CHEST)) {
      paramWorld.setTypeAndData(i, j, k, Blocks.CHEST, 0, 2);
