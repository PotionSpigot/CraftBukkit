  ...
  public void e(World world, int i, int j, int k) {
    if (!world.worldProvider.g) {
      ...
      if (world.paperSpigotConfig.invertedDaylightDetectors) {
        i1 = Math.round(i1 * MathHelper.cos(f) * -1.0F + 15.0F);
        if (i1 < 10) {
          i1 = 0;
        }
      ...
      if (l != i1) {
        i1 = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callRedstoneChange(world, i, j, k, l, i1).getNewCurrent();
