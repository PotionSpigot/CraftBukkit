  ...
  extends WorldGenVillagePiece
{
  ...
  protected void b(NBTTagCompound paramNBTTagCompound)
  {
    ...
    this.a = Block.getById(paramNBTTagCompound.getInt("CA"));
    this.b = Block.getById(paramNBTTagCompound.getInt("CB"));
    this.c = Block.getById(paramNBTTagCompound.getInt("CC"));
    this.d = Block.getById(paramNBTTagCompound.getInt("CD"));
  }
