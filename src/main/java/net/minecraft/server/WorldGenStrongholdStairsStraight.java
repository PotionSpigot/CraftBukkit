  ...
  extends WorldGenStrongholdPiece
{
  ...
  public boolean a(World paramWorld, Random paramRandom, StructureBoundingBox paramStructureBoundingBox)
  {
    ...
    a(paramWorld, paramStructureBoundingBox, 0, 0, 0, 4, 10, 7, true, paramRandom, WorldGenStrongholdPieces.c());
    ...
    int i = a(Blocks.COBBLESTONE_STAIRS, 2);
    for (int j = 0; j < 6; j++) {
      a(paramWorld, Blocks.COBBLESTONE_STAIRS, i, 1, 6 - j, 1 + j, paramStructureBoundingBox);
      a(paramWorld, Blocks.COBBLESTONE_STAIRS, i, 2, 6 - j, 1 + j, paramStructureBoundingBox);
      a(paramWorld, Blocks.COBBLESTONE_STAIRS, i, 3, 6 - j, 1 + j, paramStructureBoundingBox);
      if (j < 5) {
        a(paramWorld, Blocks.SMOOTH_BRICK, 0, 1, 5 - j, 1 + j, paramStructureBoundingBox);
        a(paramWorld, Blocks.SMOOTH_BRICK, 0, 2, 5 - j, 1 + j, paramStructureBoundingBox);
        a(paramWorld, Blocks.SMOOTH_BRICK, 0, 3, 5 - j, 1 + j, paramStructureBoundingBox);
      }
    }
