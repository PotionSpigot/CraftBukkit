...
public class ItemBoat extends Item
{
  ...
  public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman) {
    ...
    if (movingobjectposition.type == EnumMovingObjectType.BLOCK) {
      ...
      org.bukkit.event.player.PlayerInteractEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callPlayerInteractEvent(entityhuman, org.bukkit.event.block.Action.RIGHT_CLICK_BLOCK, i, j, k, movingobjectposition.face, itemstack);
      ...
      entityboat.yaw = (((MathHelper.floor(entityhuman.yaw * 4.0F / 360.0F + 0.5D) & 0x3) - 1) * 90);
