...
public class ChunkProviderHell implements IChunkProvider
{
  ...
  public void a(int i, int j, Block[] ablock) {
    ...
    this.p = a(this.p, i * b0, 0, j * b0, k, b2, l);
    ...
    for (int k = 0; k < 16; k++) {
      for (int l = 0; l < 16; l++) {
        ...
        for (int k1 = 127; k1 >= 0; k1--) {
          ...
          if (k1 < 127 - (this.o.paperSpigotConfig.generateFlatBedrock ? 0 : this.i.nextInt(5)))
            if (k1 > (this.o.paperSpigotConfig.generateFlatBedrock ? 0 : this.i.nextInt(5)))
            {
  ...
  private double[] a(double[] adouble, int i, int j, int k, int l, int i1, int j1) {
    ...
    for (int i2 = 0; i2 < i1; i2++) {
      adouble1[i2] = (Math.cos(i2 * 3.141592653589793D * 6.0D / i1) * 2.0D);
      double d2 = i2;
    ...
    for (i2 = 0; i2 < l; i2++) {
      for (int j2 = 0; j2 < j1; j2++) {
        ...
        for (int k2 = 0; k2 < i1; k2++) {
          ...
          if (k2 > i1 - 4) {
            double d11 = (k2 - (i1 - 4)) / 3.0F;
            d6 = d6 * (1.0D - d11) + -10.0D * d11;
          }
          
          if (k2 < d4) {
            double d11 = (d4 - k2) / 4.0D;
            if (d11 < 0.0D) {
              d11 = 0.0D;
            }
  ...
  public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
    ...
    if (this.o.paperSpigotConfig.generateFortress) { this.c.a(this.o, this.i, i, j);
    }
    ...
    for (int i1 = 0; i1 < 8; i1++) {
      int j1 = k + this.i.nextInt(16) + 8;
      int k1 = this.i.nextInt(120) + 4;
      int l1 = l + this.i.nextInt(16) + 8;
    ...
    for (int j1 = 0; j1 < i1; j1++) {
      ...
      int l1 = this.i.nextInt(120) + 4;
      int i2 = l + this.i.nextInt(16) + 8;
    ...
    for (int k1 = 0; k1 < 16; k1++) {
      int l1 = k + this.i.nextInt(16);
      int i2 = this.i.nextInt(108) + 10;
      int j2 = l + this.i.nextInt(16);
  ...
  public java.util.List getMobsFor(EnumCreatureType enumcreaturetype, int i, int j, int k) {
  ...
  public void recreateStructures(int i, int j) {
    if (this.o.paperSpigotConfig.generateFortress) this.c.a(this, this.o, i, j, (Block[])null);
  }
}
