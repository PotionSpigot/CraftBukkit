...
public class EntityZombie extends EntityMonster
{
  ...
  public EntityZombie(World world) {
    ...
    if (world.spigotConfig.zombieAggressiveTowardsVillager) this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, EntityVillager.class, 0, false));
    a(0.6F, 1.8F);
  }
  ...
  protected void aD() {
    ...
    getAttributeMap().b(bp).setValue(this.random.nextDouble() * 0.10000000149011612D);
  }
  ...
  public void e() {
    ...
    if ((am()) && (getGoalTarget() != null) && ((this.vehicle instanceof EntityChicken))) {
  ...
  public boolean damageEntity(DamageSource damagesource, float f) {
    ...
    if ((entityliving != null) && (this.world.difficulty == EnumDifficulty.HARD) && (this.random.nextFloat() < getAttributeInstance(bp).getValue())) {
      ...
      for (int l = 0; l < 50; l++) {
        ...
        if ((World.a(this.world, i1, j1 - 1, k1)) && (this.world.getLightLevel(i1, j1, k1) < 10)) {
          ...
          if ((this.world.b(entityzombie.boundingBox)) && (this.world.getCubes(entityzombie, entityzombie.boundingBox).isEmpty()) && (!this.world.containsLiquid(entityzombie.boundingBox))) {
            ...
            EntityTargetLivingEntityEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callEntityTargetLivingEvent(entityzombie, entityliving, org.bukkit.event.entity.EntityTargetEvent.TargetReason.REINFORCEMENT_TARGET);
            if (!event.isCancelled()) {
              if (event.getTarget() == null) {
                entityzombie.setGoalTarget(null);
              } else {
                entityzombie.setGoalTarget(((CraftLivingEntity)event.getTarget()).getHandle());
              }
            }
  ...
  public boolean n(Entity entity) {
    ...
    if (flag) {
      ...
      if ((be() == null) && (isBurning()) && (this.random.nextFloat() < i * 0.3F))
      {
  ...
  public GroupDataEntity prepare(GroupDataEntity groupdataentity) {
    ...
    h(this.random.nextFloat() < 0.55F * f);
    if (object == null) {
    ...
    double d0 = this.random.nextDouble() * 1.5D * this.world.b(this.locX, this.locY, this.locZ);
    ...
    if (this.random.nextFloat() < f * 0.05F) {
      ...
      getAttributeInstance(GenericAttributes.maxHealth).a(new AttributeModifier("Leader zombie bonus", this.random.nextDouble() * 3.0D + 1.0D, 2));
      a(true);
    }
