  ...
  implements IChunkProvider
{
  ...
  public void a(int paramInt1, int paramInt2, Block[] paramArrayOfBlock, BiomeBase[] paramArrayOfBiomeBase)
  {
    int i1 = 2;
          ...
          for (int i8 = 0; i8 < 4; i8++) {
            ...
            for (int i9 = 0; i9 < 8; i9++) {
              ...
              for (int i12 = 0; i12 < 8; i12++)
              {
                ...
                if (d16 > 0.0D) {
                  localBlock = Blocks.WHITESTONE;
                }
                paramArrayOfBlock[i10] = localBlock;
                i10 += i11;
                d16 += d17;
              }
              d11 += d13;
  ...
  public void b(int paramInt1, int paramInt2, Block[] paramArrayOfBlock, BiomeBase[] paramArrayOfBiomeBase) {
    for (int i1 = 0; i1 < 16; i1++) {
      for (int i2 = 0; i2 < 16; i2++) {
        int i3 = 1;
        int i4 = -1;
        
        Block localBlock1 = Blocks.WHITESTONE;
        Block localBlock2 = Blocks.WHITESTONE;
        
        for (int i5 = 127; i5 >= 0; i5--) {
          int i6 = (i2 * 16 + i1) * 128 + i5;
          
          Block localBlock3 = paramArrayOfBlock[i6];
          if ((localBlock3 == null) || (localBlock3.getMaterial() == Material.AIR)) {
            ...
            if (i4 == -1) {
              if (i3 <= 0) {
                localBlock1 = null;
                localBlock2 = Blocks.WHITESTONE;
              }
              
              i4 = i3;
              if (i5 >= 0) paramArrayOfBlock[i6] = localBlock1; else
                paramArrayOfBlock[i6] = localBlock2;
            } else if (i4 > 0) {
              i4--;
              paramArrayOfBlock[i6] = localBlock2;
            }
  ...
  public Chunk getOrCreateChunk(int paramInt1, int paramInt2)
  {
    ...
    Block[] arrayOfBlock = new Block[32768];
    this.o = this.m.getWorldChunkManager().getBiomeBlock(this.o, paramInt1 * 16, paramInt2 * 16, 16, 16);
    
    a(paramInt1, paramInt2, arrayOfBlock, this.o);
    b(paramInt1, paramInt2, arrayOfBlock, this.o);
    
    Chunk localChunk = new Chunk(this.m, arrayOfBlock, paramInt1, paramInt2);
    byte[] arrayOfByte = localChunk.m();
    
    for (int i1 = 0; i1 < arrayOfByte.length; i1++) {
      arrayOfByte[i1] = ((byte)this.o[i1].id);
    }
