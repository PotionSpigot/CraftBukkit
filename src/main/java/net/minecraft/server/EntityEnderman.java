...
public class EntityEnderman extends EntityMonster
{
  ...
  private static boolean[] br = new boolean['Ā'];
  private int bs;
  private int bt;
  private Entity bu;
  private boolean bv;
  ...
  private boolean f(EntityHuman entityhuman) {
    ...
    Vec3D vec3d1 = Vec3D.a(this.locX - entityhuman.locX, this.boundingBox.b + this.length / 2.0F - (entityhuman.locY + entityhuman.getHeadHeight()), this.locZ - entityhuman.locZ);
    double d0 = vec3d1.b();
  ...
  public void e()
  {
      ...
      if (getCarried().getMaterial() == Material.AIR) {
        ...
        if ((block.getMaterial() == Material.AIR) && (block1.getMaterial() != Material.AIR) && (block1.d()))
        {
          if (!CraftEventFactory.callEntityChangeBlockEvent(this, i, j, k, getCarried(), getCarriedData()).isCancelled()) {
            this.world.setTypeAndData(i, j, k, getCarried(), getCarriedData(), 3);
    ...
    if ((cd()) && (!this.bv) && (this.random.nextInt(100) == 0)) {
      a(false);
    }
    ...
    if ((!this.world.isStatic) && (isAlive())) {
      if (this.target != null) {
        if (((this.target instanceof EntityHuman)) && (f((EntityHuman)this.target))) {
          if (this.target.f(this) < 16.0D) {
            bZ();
          }
          
          this.bs = 0;
        } else if ((this.target.f(this) > 256.0D) && (this.bs++ >= 30) && (c(this.target))) {
          this.bs = 0;
        }
      } else {
        a(false);
  ...
  protected boolean c(Entity entity) {
    Vec3D vec3d = Vec3D.a(this.locX - entity.locX, this.boundingBox.b + this.length / 2.0F - entity.locY + entity.getHeadHeight(), this.locZ - entity.locZ);
  ...
  public void setCarried(Block block) {
    this.datawatcher.watch(16, new ProtocolData.ByteShort((short)Block.getId(block)));
  }
