...
public class BlockLever extends Block
{
  ...
  public boolean canPlace(World world, int i, int j, int k, int l) {
    return (l == 0) && (world.getType(i, j + 1, k).r());
  }
  
  public boolean canPlace(World world, int i, int j, int k) {
    return World.a(world, i, j - 1, k) ? true : world.getType(i, j, k + 1).r() ? true : world.getType(i, j, k - 1).r() ? true : world.getType(i + 1, j, k).r() ? true : world.getType(i - 1, j, k).r() ? true : world.getType(i, j + 1, k).r();
  }
  ...
  public void postPlace(World world, int i, int j, int k, EntityLiving entityliving, ItemStack itemstack) {
    ...
    if (i1 == b(1)) {
      if ((MathHelper.floor(entityliving.yaw * 4.0F / 360.0F + 0.5D) & 0x1) == 0) {
        world.setData(i, j, k, 0x5 | j1, 2);
      } else {
        world.setData(i, j, k, 0x6 | j1, 2);
      }
    } else if (i1 == b(0)) {
      if ((MathHelper.floor(entityliving.yaw * 4.0F / 360.0F + 0.5D) & 0x1) == 0) {
        world.setData(i, j, k, 0x7 | j1, 2);
      } else {
        world.setData(i, j, k, 0x0 | j1, 2);
      }
    }
  }
  ...
  public void doPhysics(World world, int i, int j, int k, Block block)
  {
    if (e(world, i, j, k)) {
      ...
      if ((!World.a(world, i, j - 1, k)) && (l == 5)) {
        flag = true;
      }
      
      if ((!World.a(world, i, j - 1, k)) && (l == 6)) {
        flag = true;
      }
  ...
  public int c(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    ...
    return (j1 == 1) && (l == 5) ? 15 : (j1 == 2) && (l == 4) ? 15 : (j1 == 3) && (l == 3) ? 15 : (j1 == 4) && (l == 2) ? 15 : (j1 == 5) && (l == 1) ? 15 : (j1 == 6) && (l == 1) ? 15 : (j1 == 7) && (l == 0) ? 15 : (j1 == 0) && (l == 0) ? 15 : 0;
  }
