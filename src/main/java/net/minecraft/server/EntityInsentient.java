...
public abstract class EntityInsentient extends EntityLiving
{
  ...
  public boolean persistent = !isTypeNotPersistent();
  protected float f;
  private Entity bu;
  protected int g;
  private boolean bv;
  ...
  public EntityLiving getGoalTarget() {
    return (EntityLiving)this.goalTarget.get();
  }
  ...
  public void s()
  {
    for (int i = 0; i < 20; i++) {
      ...
      this.world.addParticle("explode", this.locX + this.random.nextFloat() * this.width * 2.0F - this.width - d0 * d3, this.locY + this.random.nextFloat() * this.length - d1 * d3, this.locZ + this.random.nextFloat() * this.width * 2.0F - this.width - d2 * d3, d0, d1, d2);
    }
  }
  ...
  public void e() {
    ...
    if ((!this.world.isStatic) && (bJ()) && (!this.aT) && (this.world.getGameRules().getBoolean("mobGriefing"))) {
  ...
  protected void w() {
    if (this.persistent) {
      ...
      EntityHuman entityhuman = this.world.findNearbyPlayerWhoAffectsSpawning(this, -1.0D);
      ...
      if (entityhuman != null) {
        ...
        if (d3 > this.world.paperSpigotConfig.hardDespawnDistance.intValue()) {
          die();
        }
        
        if ((this.aU > 600) && (this.random.nextInt(800) == 0) && (d3 > this.world.paperSpigotConfig.softDespawnDistance.intValue())) {
          die();
        } else if (d3 < this.world.paperSpigotConfig.softDespawnDistance.intValue()) {
          this.aU = 0;
        }
      }
    }
  ...
  protected void bn() {
    ...
    if (this.fromMobSpawner)
    {
      ...
      if (this.goalFloat != null) {
        if (this.goalFloat.a()) this.goalFloat.e();
        this.bm.b();
      }
  ...
  protected void bq() {
    ...
    if (this.bu != null) {
      a(this.bu, 10.0F, x());
      if ((this.g-- <= 0) || (this.bu.dead) || (this.bu.f(this) > f * f)) {
        this.bu = null;
      }
    } else {
  ...
  protected void bD()
  {
    ...
    if ((be() != null) && (this.random.nextFloat() < 0.25F * f)) {
      EnchantmentManager.a(this.random, be(), (int)(5.0F + f * this.random.nextInt(18)));
    }
    
    for (int i = 0; i < 4; i++) {
      ItemStack itemstack = r(i);
  ...
  public GroupDataEntity prepare(GroupDataEntity groupdataentity) {
    getAttributeInstance(GenericAttributes.b).a(new AttributeModifier("Random spawn bonus", this.random.nextGaussian() * 0.05D, 1));
  ...
  public final boolean c(EntityHuman entityhuman) {
    ...
    return a(entityhuman) ? true : super.c(entityhuman);
  }
  ...
  protected void bL() {
    ...
    if ((this.bv) && (
      (this.bw == null) || (this.bw.dead))) {
      this.world.getServer().getPluginManager().callEvent(new org.bukkit.event.entity.EntityUnleashEvent(getBukkitEntity(), org.bukkit.event.entity.EntityUnleashEvent.UnleashReason.HOLDER_GONE));
      unleash(true, true);
    }
  }
  ...
  public void unleash(boolean flag, boolean flag1)
  {
    if (this.bv) {
      ...
      if ((!this.world.isStatic) && (flag) && ((this.world instanceof WorldServer))) {
        ((WorldServer)this.world).getTracker().a(this, new PacketPlayOutAttachEntity(1, this, (Entity)null));
      }
    }
  }
  ...
  private void bP() {
    if ((this.bv) && (this.bx != null)) {
      if ((this.bx.hasKeyOfType("UUIDMost", 4)) && (this.bx.hasKeyOfType("UUIDLeast", 4))) {
        ...
        this.world.getServer().getPluginManager().callEvent(new org.bukkit.event.entity.EntityUnleashEvent(getBukkitEntity(), org.bukkit.event.entity.EntityUnleashEvent.UnleashReason.UNKNOWN));
        unleash(false, true);
      }
    }
