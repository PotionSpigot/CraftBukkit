...
public class ChunkProviderFlat implements IChunkProvider
{
  private World a;
  private Random b;
  private final Block[] c = new Block['Ā'];
  private final byte[] d = new byte['Ā'];
  private final WorldGenFlatInfo e;
  private final List f = new java.util.ArrayList();
  ...
  public ChunkProviderFlat(World world, long i, boolean flag, String s) {
    ...
    if (flag) {
      ...
      if ((world.paperSpigotConfig.generateVillage) && (map.containsKey("village"))) {
      ...
      if ((world.paperSpigotConfig.generateTemple) && (map.containsKey("biome_1"))) {
        this.f.add(new WorldGenLargeFeature((Map)map.get("biome_1")));
      }
      
      if ((world.paperSpigotConfig.generateMineshaft) && (map.containsKey("mineshaft"))) {
        this.f.add(new WorldGenMineshaft((Map)map.get("mineshaft")));
      }
      
      if ((world.paperSpigotConfig.generateStronghold) && (map.containsKey("stronghold"))) {
      ...
      if (block != null) {
        ...
        for (int i1 = 0; i1 < 16; i1++) {
          for (int j1 = 0; j1 < 16; j1++) {
            chunksection.setTypeId(i1, l & 0xF, j1, block);
            chunksection.setData(i1, l & 0xF, j1, this.d[l]);
          }
        }
      }
    }
  ...
  public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
    ...
    if ((this.i != null) && (!flag) && (this.b.nextInt(4) == 0)) {
      int l1 = k + this.b.nextInt(16) + 8;
      int k1 = this.b.nextInt(256);
      int i2 = l + this.b.nextInt(16) + 8;
      this.i.generate(this.a, this.b, l1, k1, i2);
    }
    
    if ((this.j != null) && (!flag) && (this.b.nextInt(8) == 0)) {
      int l1 = k + this.b.nextInt(16) + 8;
      int k1 = this.b.nextInt(this.b.nextInt(248) + 8);
      int i2 = l + this.b.nextInt(16) + 8;
    ...
    if (this.h) {
      for (int l1 = 0; l1 < 8; l1++) {
        int k1 = k + this.b.nextInt(16) + 8;
        int i2 = this.b.nextInt(256);
