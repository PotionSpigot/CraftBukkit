    ...
    for (int n = 0; n < paramInt4; n++) {
      for (int i1 = 0; i1 < paramInt3; i1++) {
        ...
        if ((i6 == 0) && ((i2 != 0) || (i3 != 0) || (i4 != 0) || (i5 != 0))) {
          int i7 = 1;
          int i8 = 1;
          if ((i2 != 0) && (a(i7++) == 0)) i8 = i2;
          if ((i3 != 0) && (a(i7++) == 0)) i8 = i3;
          if ((i4 != 0) && (a(i7++) == 0)) i8 = i4;
          if ((i5 != 0) && (a(i7++) == 0)) i8 = i5;
          if (a(3) == 0) {
            arrayOfInt2[(i1 + n * paramInt3)] = i8;
          }
          else if (i8 == 4) arrayOfInt2[(i1 + n * paramInt3)] = 4; else {
            arrayOfInt2[(i1 + n * paramInt3)] = 0;
          }
        } else if ((i6 > 0) && ((i2 == 0) || (i3 == 0) || (i4 == 0) || (i5 == 0))) {
          if (a(5) == 0) {
            if (i6 == 4) arrayOfInt2[(i1 + n * paramInt3)] = 4; else
              arrayOfInt2[(i1 + n * paramInt3)] = 0;
          } else arrayOfInt2[(i1 + n * paramInt3)] = i6;
        } else {
