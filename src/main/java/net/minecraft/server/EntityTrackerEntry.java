...
public class EntityTrackerEntry
{
  ...
  private boolean x;
  public boolean n;
  public Set trackedPlayers = new java.util.HashSet();
  public Set<EntityPlayer> freshViewers = com.google.common.collect.Sets.newHashSet();
  ...
  public void track(List list) {
    ...
    if ((this.tracker instanceof EntityItemFrame)) {
      ...
      if ((this.m % 10 == 0) && (i4 != null) && ((i4.getItem() instanceof ItemWorldMap))) {
        ...
        Iterator i7 = this.trackedPlayers.iterator();
      ...
      if (this.tracker.vehicle == null) {
        ...
        if (object != null)
        {
          ...
          if ((object instanceof PacketPlayOutEntityTeleport)) {
            ...
            for (EntityPlayer viewer : this.trackedPlayers) {
    ...
    if (entityplayer != this.tracker) {
      ...
      if ((d0 >= -this.b) && (d0 <= this.b) && (d1 >= -this.b) && (d1 <= this.b)) {
        if ((!this.trackedPlayers.contains(entityplayer)) && ((d(entityplayer)) || (this.tracker.attachedToPlayer)))
        {
          ...
          this.freshViewers.add(entityplayer);
