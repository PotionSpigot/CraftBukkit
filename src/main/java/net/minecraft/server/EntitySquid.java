...
public class EntitySquid extends EntityWaterAnimal
{
  ...
  public void e()
  {
    ...
    if (M())
    {
      ...
      this.aM += (-(float)org.bukkit.craftbukkit.v1_7_R4.TrigMath.atan2(this.motX, this.motZ) * 180.0F / 3.1415927F - this.aM) * 0.1F;
      this.yaw = this.aM;
      this.br += 3.1415927F * this.bz * 1.5F;
      
      this.bp += (-(float)org.bukkit.craftbukkit.v1_7_R4.TrigMath.atan2(f, this.motY) * 180.0F / 3.1415927F - this.bp) * 0.1F;
    } else {
