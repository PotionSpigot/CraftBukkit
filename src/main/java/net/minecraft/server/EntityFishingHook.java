...
public class EntityFishingHook extends Entity
{
        ...
        if ((!this.world.isStatic) && (d6 > 0.0D)) {
          ...
          if (this.ax > 0) {
            ...
            if (this.az <= 0) {
              ...
              float f4 = this.aA * 0.017453292F;
              float f5 = MathHelper.sin(f4);
              float f3 = MathHelper.cos(f4);
            ...
            float f4 = 0.15F;
            if (this.ay < 20) {
              f4 = (float)(f4 + (20 - this.ay) * 0.05D);
            } else if (this.ay < 40) {
              f4 = (float)(f4 + (40 - this.ay) * 0.02D);
            } else if (this.ay < 60) {
              f4 = (float)(f4 + (60 - this.ay) * 0.01D);
            }
            
            if (this.random.nextFloat() < f4) {
              float f5 = MathHelper.a(this.random, 0.0F, 360.0F) * 0.017453292F;
              float f3 = MathHelper.a(this.random, 25.0F, 60.0F);
              double d9 = this.locX + MathHelper.sin(f5) * f3 * 0.1F;
              double d11 = MathHelper.floor(this.boundingBox.b) + 1.0F;
              double d10 = this.locZ + MathHelper.cos(f5) * f3 * 0.1F;
  ...
  public void a(NBTTagCompound nbttagcompound) {
    ...
    this.at = Block.getById(nbttagcompound.getByte("inTile") & 0xFF);
