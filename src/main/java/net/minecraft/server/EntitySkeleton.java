...
public class EntitySkeleton extends EntityMonster implements IRangedEntity
{
  ...
  public boolean n(Entity entity)
  {
    if (super.n(entity))
    {
      if ((getSkeletonType() == 1) && ((entity instanceof EntityLiving))) {
        ((EntityLiving)entity).addEffect(new MobEffect(MobEffectList.WITHER.id, 200), org.bukkit.event.entity.PotionEffectAddEvent.EffectCause.WITHER_SKELETON);
      }
      return true;
    }
    return false;
  ...
  public GroupDataEntity prepare(GroupDataEntity groupdataentity) {
    ...
    if (((this.world.worldProvider instanceof WorldProviderHell)) && (aI().nextInt(5) > 0)) {
  ...
  public void a(EntityLiving entityliving, float f) {
    ...
    EntityShootBowEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callEntityShootBowEvent(this, be(), entityarrow, 0.8F);
    if (event.isCancelled()) {
