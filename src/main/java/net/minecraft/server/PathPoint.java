...
public class PathPoint
{
  ...
  public static int a(int paramInt1, int paramInt2, int paramInt3) { return paramInt2 & 0xFF | (paramInt1 & 0x7FFF) << 8 | (paramInt3 & 0x7FFF) << 24 | (paramInt1 < 0 ? Integer.MIN_VALUE : 0) | (paramInt3 < 0 ? 32768 : 0); }
  
  PathPoint h;
  public boolean i;
  public float a(PathPoint paramPathPoint) { float f1 = paramPathPoint.a - this.a;
