...
public class AxisAlignedBB {
  ...
  public AxisAlignedBB a(AxisAlignedBB paramAxisAlignedBB) {
    double d1 = Math.min(this.a, paramAxisAlignedBB.a);
    double d2 = Math.min(this.b, paramAxisAlignedBB.b);
    double d3 = Math.min(this.c, paramAxisAlignedBB.c);
    double d4 = Math.max(this.d, paramAxisAlignedBB.d);
    double d5 = Math.max(this.e, paramAxisAlignedBB.e);
    double d6 = Math.max(this.f, paramAxisAlignedBB.f);
    
    return a(d1, d2, d3, d4, d5, d6);
  }
  
  public AxisAlignedBB c(double paramDouble1, double paramDouble2, double paramDouble3) {
    return a(this.a + paramDouble1, this.b + paramDouble2, this.c + paramDouble3, this.d + paramDouble1, this.e + paramDouble2, this.f + paramDouble3);
  }
