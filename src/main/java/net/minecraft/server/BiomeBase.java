...
public abstract class BiomeBase
{
  ...
  public WorldGenTreeAbstract a(Random random) {
    return random.nextInt(10) == 0 ? this.aA : this.az;
  }
  ...
  public List getMobs(EnumCreatureType enumcreaturetype) {
    return enumcreaturetype == EnumCreatureType.AMBIENT ? this.av : enumcreaturetype == EnumCreatureType.WATER_CREATURE ? this.au : enumcreaturetype == EnumCreatureType.CREATURE ? this.at : enumcreaturetype == EnumCreatureType.MONSTER ? this.as : null;
  }
  ...
  public final float a(int i, int j, int k) {
    if (j > 64) {
      float f = (float)ac.a(i * 1.0D / 8.0D, k * 1.0D / 8.0D) * 4.0F;
      
      return this.temperature - (f + j - 64.0F) * 0.05F / 30.0F;
    }
  ...
  public boolean a(BiomeBase biomebase) {
    return biomebase == this;
  }
  
  public EnumTemperature m() {
    return this.temperature < 1.0D ? EnumTemperature.MEDIUM : this.temperature < 0.2D ? EnumTemperature.COLD : EnumTemperature.WARM;
  }
