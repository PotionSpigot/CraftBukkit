      ...
      if (movingobjectposition.entity != null)
      {
        ...
        if (this.shooter != null) {
          ...
          if ((didDamage) && (!movingobjectposition.entity.isAlive())) {
            this.shooter.heal(5.0F, org.bukkit.event.entity.EntityRegainHealthEvent.RegainReason.WITHER);
          }
        } else {
        ...
        if ((didDamage) && ((movingobjectposition.entity instanceof EntityLiving)))
        {
          ...
          if (b0 > 0) {
            ((EntityLiving)movingobjectposition.entity).addEffect(new MobEffect(MobEffectList.WITHER.id, 20 * b0, 1), org.bukkit.event.entity.PotionEffectAddEvent.EffectCause.WITHER_SKULL);
          }
        }
      }
