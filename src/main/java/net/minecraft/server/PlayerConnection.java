...
public class PlayerConnection implements PacketPlayInListener
{
  ...
  private long k;
  private volatile int chatThrottle; private static final AtomicIntegerFieldUpdater chatSpamField = AtomicIntegerFieldUpdater.newUpdater(PlayerConnection.class, "chatThrottle");
  private int x;
  ...
  public PlayerConnection(MinecraftServer minecraftserver, NetworkManager networkmanager, EntityPlayer entityplayer) { this.minecraftServer = minecraftserver;
  ...
  public void a()
  {
    ...
    if ((this.player.x() > 0L) && (this.minecraftServer.getIdleTimeout() > 0) && (MinecraftServer.ar() - this.player.x() > this.minecraftServer.getIdleTimeout() * 1000 * 60)) {
  ...
  public void a(PacketPlayInFlying packetplayinflying)
  {
    ...
    if (!this.player.viewingCredits)
    {
      ...
      if ((this.checkMovement) && (!this.player.dead))
      {
        ...
        if ((d10 > SpigotConfig.movedTooQuicklyThreshold) && (this.checkMovement) && ((!this.minecraftServer.N()) || (!this.minecraftServer.M().equals(this.player.getName())))) {
        ...
        if ((d10 > SpigotConfig.movedWronglyThreshold) && (!this.player.isSleeping()) && (!this.player.playerInteractManager.isCreative())) {
          flag1 = true;
  ...
  public void a(PacketPlayInBlockPlace packetplayinblockplace) {
    ...
    if ((PaperSpigotConfig.interactLimitEnabled) && (this.lastPlace != -1L) && (packetplayinblockplace.timestamp - this.lastPlace < 30L) && (this.packets++ >= 4)) {
      throttled = true;
    ...
    if (packetplayinblockplace.getFace() == 255) {
      ...
      if (reachDistance > (getPlayer().getGameMode() == org.bukkit.GameMode.CREATIVE ? 49 : 36)) {
        return;
      }
  ...
  {
    if (((Integer)NetworkManager.a(this.networkManager).attr(NetworkManager.protocolVersion).get()).intValue() >= 17)
    {
      if ((packet instanceof PacketPlayOutWindowItems))
      {
        PacketPlayOutWindowItems items = (PacketPlayOutWindowItems)packet;
        if (((this.player.activeContainer instanceof ContainerEnchantTable)) && (this.player.activeContainer.windowId == items.a))
        {
  ...
  public void a(PacketPlayInChat packetplayinchat) {
    if ((this.player.dead) || (this.player.getChatFlags() == EnumChatVisibility.HIDDEN)) {
      ...
      s = net.minecraft.util.org.apache.commons.lang3.StringUtils.normalizeSpace(s);
      Waitable waitable;
  ...
  public void chat(String s, boolean async)
  {
    ...
    } else if (this.player.getChatFlags() != EnumChatVisibility.SYSTEM)
    {
      ...
      {
        queueEvent = new PlayerChatEvent(player, event.getMessage(), event.getFormat(), event.getRecipients());
  ...
  public void a(PacketPlayInArmAnimation packetplayinarmanimation)
  {
    ...
    if (packetplayinarmanimation.d() == 1)
    {
      ...
      float f7 = f4 * f5;
      float f8 = f3 * f5;
      double d3 = this.player.playerInteractManager.getGameMode() == EnumGamemode.CREATIVE ? 5.0D : 4.5D;
  ...
  public void a(PacketPlayInUseEntity packetplayinuseentity) {
    if (packetplayinuseentity.c() == null) return;
    if (this.player.dead) return;
    WorldServer worldserver = this.minecraftServer.getWorldServer(this.player.dimension);
  ...
  public void a(PacketPlayInWindowClick packetplayinwindowclick) {
    ...
    this.player.v();
    if (!this.player.activeContainer.a(this.player)) return;
    if ((this.player.activeContainer.windowId == packetplayinwindowclick.c()) && (this.player.activeContainer.c(this.player)))
    {
      if ((packetplayinwindowclick.d() < -1) && (packetplayinwindowclick.d() != 64537)) {
        return;
      }
      ...
      if (((Integer)NetworkManager.a(this.networkManager).attr(NetworkManager.protocolVersion).get()).intValue() >= 17)
      {
        if ((this.player.activeContainer instanceof ContainerEnchantTable))
        {
          ...
          if (packetplayinwindowclick.slot > 1)
          {
            packetplayinwindowclick.slot -= 1;
          }
        }
      }
      ...
      if (packetplayinwindowclick.d() == -1) {
        ...
        if ((packetplayinwindowclick.e() == 0) || (packetplayinwindowclick.e() == 1)) {
          action = InventoryAction.NOTHING;
          if (packetplayinwindowclick.d() == 64537) {
  ...
  public void a(PacketPlayInSetCreativeSlot packetplayinsetcreativeslot) {
    if (this.player.playerInteractManager.isCreative()) {
      ...
      if ((flag) || ((flag1) && (!ItemStack.matches(this.player.defaultContainer.getSlot(packetplayinsetcreativeslot.c()).getItem(), packetplayinsetcreativeslot.getItemStack()))))
      {
        ...
        InventoryCreativeEvent event = new InventoryCreativeEvent(inventory, type, flag ? 64537 : packetplayinsetcreativeslot.c(), item);
        this.server.getPluginManager().callEvent(event);
      ...
      {
        this.player.playerConnection.sendPacket(new PacketPlayOutSetSlot(0, packetplayinsetcreativeslot
  ...
  public void a(PacketPlayInUpdateSign packetplayinupdatesign) {
    ...
    if (worldserver.isLoaded(packetplayinupdatesign.c(), packetplayinupdatesign.d(), packetplayinupdatesign.e())) {
      ...
      if ((tileentity instanceof TileEntitySign)) {
        ...
        SignChangeEvent event = new SignChangeEvent((org.bukkit.craftbukkit.v1_7_R4.block.CraftBlock)player.getWorld().getBlockAt(j, k, i), this.server.getPlayer(this.player), packetplayinupdatesign.f());
        this.server.getPluginManager().callEvent(event);
        
        if (!event.isCancelled()) {
          tileentitysign1.lines = org.bukkit.craftbukkit.v1_7_R4.block.CraftSign.sanitizeLines(event.getLines());
  ...
  public void a(PacketPlayInCustomPayload packetplayincustompayload)
  {
    ...
    if ("MC|BEdit".equals(packetplayincustompayload.c())) {
      PacketDataSerializer packetdataserializer = new PacketDataSerializer(Unpooled.wrappedBuffer(packetplayincustompayload.e()), this.networkManager.getVersion());
      try
      {
    ...
    if ("MC|TrSel".equals(packetplayincustompayload.c())) {
      ...
      if (!this.minecraftServer.getEnableCommandBlock()) {
        ...
        this.player.sendMessage(new ChatMessage("advMode.notAllowed", new Object[0])); } } else { Slot slot;
      ...
      if ("MC|Beacon".equals(packetplayincustompayload.c())) {
        if ((this.player.activeContainer instanceof ContainerBeacon))
          try {
            ...
            slot = containerbeacon.getSlot(0);
            
            if (slot.hasItem()) {
              slot.a(1);
              tileentitybeacon = containerbeacon.e();
        ...
        if (("MC|ItemName".equals(packetplayincustompayload.c())) && ((this.player.activeContainer instanceof ContainerAnvil))) {
          ...
          if ((packetplayincustompayload.e() != null) && (packetplayincustompayload.e().length >= 1)) {
            s1 = SharedConstants.a(new String(packetplayincustompayload.e(), net.minecraft.util.com.google.common.base.Charsets.UTF_8));
          ...
          try {
            ...
            s1 = channels.split("\000");slot = s1.length; for (Slot localSlot1 = 0; localSlot1 < slot; localSlot1++) { String channel = s1[localSlot1];
          ...
          try {
            String channels = new String(packetplayincustompayload.e(), "UTF8");
            s1 = channels.split("\000");slot = s1.length; for (Slot localSlot2 = 0; localSlot2 < slot; localSlot2++) { String channel = s1[localSlot2];
