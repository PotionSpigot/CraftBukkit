...
public class FoodMetaData {
  ...
  public FoodMetaData() { throw new AssertionError("Whoopsie, we missed the bukkit."); }
  ...
  public void a(ItemFood itemfood, ItemStack itemstack)
  {
    ...
    FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callFoodLevelChangeEvent(this.entityhuman, itemfood.getNutrition(itemstack) + oldFoodLevel);
  ...
  public void a(EntityHuman entityhuman)
  {
    ...
    if (this.exhaustionLevel > 4.0F) {
      ...
      {
        FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, Math.max(this.foodLevel - 1, 0));
