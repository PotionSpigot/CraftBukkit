...
{
  private World world;
  private final List doors = new java.util.ArrayList();
  ...
  private List aggressors = new java.util.ArrayList();
  ...
  public void tick(int i) {
    ...
    if ((this.ironGolemCount < j) && (this.doors.size() > 20) && (this.world.random.nextInt(7000) == 0)) {
      Vec3D vec3d = a(MathHelper.d(this.center.x), MathHelper.d(this.center.y), MathHelper.d(this.center.z), 2, 4, 2);
  ...
  {
    List list = this.world.a(EntityIronGolem.class, AxisAlignedBB.a(this.center.x - this.size, this.center.y - 4, this.center.z - this.size, this.center.x + this.size, this.center.y + 4, this.center.z + this.size));
    
    this.ironGolemCount = list.size();
  }
  
  private void k() {
    List list = this.world.a(EntityVillager.class, AxisAlignedBB.a(this.center.x - this.size, this.center.y - 4, this.center.z - this.size, this.center.x + this.size, this.center.y + 4, this.center.z + this.size));
