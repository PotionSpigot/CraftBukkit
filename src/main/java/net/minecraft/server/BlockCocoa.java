...
public class BlockCocoa extends BlockDirectional implements IBlockFragilePlantElement
{
  ...
  public void updateShape(IBlockAccess iblockaccess, int i, int j, int k) {
    ...
    switch (i1) {
    case 0: 
      a((8.0F - f) / 16.0F, (12.0F - l1) / 16.0F, (15.0F - k1) / 16.0F, (8.0F + f) / 16.0F, 0.75F, 0.9375F);
      break;
    
    case 1: 
      a(0.0625F, (12.0F - l1) / 16.0F, (8.0F - f) / 16.0F, (1.0F + k1) / 16.0F, 0.75F, (8.0F + f) / 16.0F);
      break;
    
    case 2: 
      a((8.0F - f) / 16.0F, (12.0F - l1) / 16.0F, 0.0625F, (8.0F + f) / 16.0F, 0.75F, (1.0F + k1) / 16.0F);
      break;
    
    case 3: 
      a((15.0F - k1) / 16.0F, (12.0F - l1) / 16.0F, (8.0F - f) / 16.0F, 0.9375F, 0.75F, (8.0F + f) / 16.0F);
    }
  }
  
  public void postPlace(World world, int i, int j, int k, EntityLiving entityliving, ItemStack itemstack) {
    int l = ((MathHelper.floor(entityliving.yaw * 4.0F / 360.0F + 0.5D) & 0x3) + 0) % 4;
  ...
  public void dropNaturally(World world, int i, int j, int k, int l, float f, int i1) {
    ...
    for (int k1 = 0; k1 < b0; k1++) {
      a(world, i, j, k, new ItemStack(Items.INK_SACK, 1, 3));
    }
  }
  ...
  public void b(World world, Random random, int i, int j, int k) {
    ...
    j1++;
    CraftEventFactory.handleBlockGrowEvent(world, i, j, k, this, j1 << 2 | i1);
  }
}
