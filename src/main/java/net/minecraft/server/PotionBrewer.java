...
public class PotionBrewer
{
  ...
  public static boolean b(Collection paramCollection) {
    for (MobEffect localMobEffect : paramCollection) {
      if (!localMobEffect.isAmbient()) { return false;
      }
    }
    return true;
  }
  ...
  private static int a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int n = paramString.indexOf('|', paramInt1);
    if ((n >= 0) && (n < paramInt2)) {
      i1 = a(paramString, paramInt1, n - 1, paramInt3);
      if (i1 > 0) {
        return i1;
      }
      
      i2 = a(paramString, n + 1, paramInt2, paramInt3);
      if (i2 > 0) {
        return i2;
      }
      return 0;
    ...
    int i7 = 0;
    int i8 = 0;
    boolean bool1; for (int i9 = paramInt1; i9 < paramInt2; i9++)
    {
      ...
      if ((localMobEffectList != null) && ((!localMobEffectList.i()) || (paramBoolean)))
      {
        ...
        if (str1 != null)
        {
          ...
          if (i2 > 0) {
            ...
            MobEffect localMobEffect = new MobEffect(localMobEffectList.getId(), i2, i3);
            if ((paramInt & 0x4000) != 0) localMobEffect.setSplash(true);
            localArrayList.add(localMobEffect);
          }
        }
      }
  ...
  {
    return (a(paramInt1, paramInt2) ? 16 : 0) | (a(paramInt1, paramInt3) ? 8 : 0) | (a(paramInt1, paramInt4) ? 4 : 0) | (a(paramInt1, paramInt5) ? 2 : 0) | (a(paramInt1, paramInt6) ? 1 : 0);
  }
}
