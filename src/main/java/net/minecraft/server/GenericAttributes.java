...
public class GenericAttributes
{
  ...
  public static final IAttribute maxHealth = new AttributeRanged("generic.maxHealth", 20.0D, 0.1D, SpigotConfig.maxHealth).a("Max Health").a(true);
  ...
  public static final IAttribute d = new AttributeRanged("generic.movementSpeed", 0.699999988079071D, 0.0D, SpigotConfig.movementSpeed).a("Movement Speed").a(true);
  public static final IAttribute e = new AttributeRanged("generic.attackDamage", 2.0D, 0.0D, SpigotConfig.attackDamage);
