...
public class EntityCreeper extends EntityMonster
{
  ...
  public void a(EntityLightning entitylightning) {
    ...
    if (org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callCreeperPowerEvent(this, entitylightning, org.bukkit.event.entity.CreeperPowerEvent.PowerCause.LIGHTNING).isCancelled()) {
      return;
    }
