...
public class EntityIronGolem extends EntityGolem {
  ...
  protected void bp() {
    if (--this.bq <= 0) {
      ...
      if (this.bp == null) {
        ...
        a(chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z, (int)(this.bp.getSize() * 0.6F));
      }
    }
  ...
  protected void o(Entity entity) {
    ...
    {
      org.bukkit.event.entity.EntityTargetLivingEntityEvent event = org.bukkit.craftbukkit.v1_7_R4.event.CraftEventFactory.callEntityTargetLivingEvent(this, (EntityLiving)entity, org.bukkit.event.entity.EntityTargetEvent.TargetReason.COLLISION);
      if (!event.isCancelled()) {
        if (event.getTarget() == null) {
          setGoalTarget(null);
        } else {
          setGoalTarget(((org.bukkit.craftbukkit.v1_7_R4.entity.CraftLivingEntity)event.getTarget()).getHandle());
        }
      }
    }
  ...
  public void e() {
    ...
    if ((this.motX * this.motX + this.motZ * this.motZ > 2.500000277905201E-7D) && (this.random.nextInt(5) == 0)) {
      ...
      if (block.getMaterial() != Material.AIR) {
        this.world.addParticle("blockcrack_" + Block.getId(block) + "_" + this.world.getData(i, j, k), this.locX + (this.random.nextFloat() - 0.5D) * this.width, this.boundingBox.b + 0.1D, this.locZ + (this.random.nextFloat() - 0.5D) * this.width, 4.0D * (this.random.nextFloat() - 0.5D), 0.5D, (this.random.nextFloat() - 0.5D) * 4.0D);
      }
    }
  }
  ...
  protected void dropDeathLoot(boolean flag, int i) {
    ...
    for (int k = 0; k < j; k++) {
      a(Item.getItemOf(Blocks.RED_ROSE), 1, 0.0F);
    }
  ...
  public void die(DamageSource damagesource) {
    if ((!isPlayerCreated()) && (this.killer != null) && (this.bp != null)) {
