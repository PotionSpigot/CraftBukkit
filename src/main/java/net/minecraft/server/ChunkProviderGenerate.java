...
public class ChunkProviderGenerate implements IChunkProvider
{
  ...
  public void a(int i, int j, Block[] ablock, byte[] abyte, BiomeBase[] abiomebase) {
    ...
    this.s = this.m.a(this.s, i * 16, j * 16, 16, 16, d0 * 2.0D, d0 * 2.0D, 1.0D);
    ...
    for (int j1 = 0; j1 < 5; j1++) {
      for (int k1 = 0; k1 < 5; k1++) {
        ...
        for (int j2 = 0; j2 < 33; j2++) {
          double d9 = (j2 - d8) * 12.0D * 128.0D / 256.0D / d7;
  ...
  public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
    ...
    if ((!flag) && (this.i.nextInt(8) == 0)) {
      int k1 = k + this.i.nextInt(16) + 8;
      int l1 = this.i.nextInt(this.i.nextInt(248) + 8);
      int i2 = l + this.i.nextInt(16) + 8;
    ...
    if (this.n.paperSpigotConfig.generateDungeon) {
      for (int k1 = 0; k1 < 8; k1++) {
        int l1 = k + this.i.nextInt(16) + 8;
        int i2 = this.i.nextInt(256);
