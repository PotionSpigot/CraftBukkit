...
public class BlockRedstoneTorch extends BlockTorch
{
  ...
  private static Map b = new java.util.WeakHashMap();
  ...
  public int b(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    ...
    return (i1 == 2) && (l == 4) ? 0 : (i1 == 1) && (l == 5) ? 0 : (i1 == 4) && (l == 2) ? 0 : (i1 == 3) && (l == 3) ? 0 : (i1 == 5) && (l == 1) ? 0 : 15;
  }
  ...
  private boolean m(World world, int i, int j, int k)
  {
    ...
    return (l == 5) && (world.isBlockFacePowered(i, j - 1, k, 0));
  }
  
  public void a(World world, int i, int j, int k, Random random) {
    boolean flag = m(world, i, j, k);
    List list = (List)b.get(world);
  ...
  public int c(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    return l == 0 ? b(iblockaccess, i, j, k, l) : 0;
  }
