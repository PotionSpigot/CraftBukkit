...
public class MovingObjectPosition
{
  ...
  public MovingObjectPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4, Vec3D paramVec3D, boolean paramBoolean) {
    this.type = (paramBoolean ? EnumMovingObjectType.BLOCK : EnumMovingObjectType.MISS);
    this.b = paramInt1;
    this.c = paramInt2;
    this.d = paramInt3;
    this.face = paramInt4;
  ...
  public MovingObjectPosition(Entity paramEntity) {
    this(paramEntity, Vec3D.a(paramEntity.locX, paramEntity.locY, paramEntity.locZ));
  }
