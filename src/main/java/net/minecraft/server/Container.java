...
public abstract class Container
{
  ...
  public int g;
  private final Set h = new java.util.HashSet();
  protected List listeners = new ArrayList();
  private Set i = new java.util.HashSet();
  ...
  public ItemStack clickItem(int i, int j, int k, EntityHuman entityhuman) {
    ...
    if (k == 5) {
      ...
      if (((i1 != 1) || (this.g != 2)) && (i1 != this.g)) {
        ...
        if (!this.h.isEmpty()) {
          ...
          for (Entry<Integer, ItemStack> ditem : draggedSlots.entrySet()) {
            eventmap.put(ditem.getKey(), CraftItemStack.asBukkitCopy((ItemStack)ditem.getValue()));
          }
      ...
      if (i == 64537) {
        if ((playerinventory.getCarried() != null) && (i == 64537)) {
          if (j == 0) {
