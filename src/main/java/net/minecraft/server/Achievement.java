...
public class Achievement extends Statistic
{
  ...
  public Achievement(String paramString1, String paramString2, int paramInt1, int paramInt2, ItemStack paramItemStack, Achievement paramAchievement) {
    ...
    if (paramInt1 < AchievementList.a) AchievementList.a = paramInt1;
    if (paramInt2 < AchievementList.b) AchievementList.b = paramInt2;
    if (paramInt1 > AchievementList.c) AchievementList.c = paramInt1;
    if (paramInt2 > AchievementList.d) AchievementList.d = paramInt2;
  ...
  {
    IChatBaseComponent localIChatBaseComponent = super.e();
    localIChatBaseComponent.getChatModifier().setColor(g() ? EnumChatFormat.DARK_PURPLE : EnumChatFormat.GREEN);
