  ...
  public static void a(OldChunk oldchunk, NBTTagCompound nbttagcompound, WorldChunkManager worldchunkmanager) {
    ...
    for (int k = 0; k < 8; k++) {
      ...
      if (!flag) {
        ...
        for (int k1 = 0; k1 < 16; k1++) {
          for (int l1 = 0; l1 < 16; l1++) {
            for (int i2 = 0; i2 < 16; i2++) {
              ...
              abyte[(l1 << 8 | i2 << 4 | k1)] = ((byte)(b1 & 0xFF));
        ...
        nbttagcompound1.setByte("Y", (byte)(k & 0xFF));
    ...
    byte[] abyte1 = new byte['Ā'];
    
    for (int k2 = 0; k2 < 16; k2++) {
      for (int j = 0; j < 16; j++) {
        abyte1[(j << 4 | k2)] = ((byte)(worldchunkmanager.getBiome(oldchunk.k << 4 | k2, oldchunk.l << 4 | j).id & 0xFF));
      }
    }
