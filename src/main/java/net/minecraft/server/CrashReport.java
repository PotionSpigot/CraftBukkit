...
public class CrashReport
{
  ...
  private void h() {
    this.d.a("Minecraft Version", new CrashReportVersion(this));
    this.d.a("Operating System", new CrashReportOperatingSystem(this));
    this.d.a("Java Version", new CrashReportJavaVersion(this));
    this.d.a("Java VM Version", new CrashReportJavaVMVersion(this));
    this.d.a("Memory", new CrashReportMemory(this));
    this.d.a("JVM Flags", new CrashReportJVMFlags(this));
    this.d.a("AABB Pool Size", new CrashReportAABBPoolSize(this));
    this.d.a("IntCache", new CrashReportIntCacheSize(this));
