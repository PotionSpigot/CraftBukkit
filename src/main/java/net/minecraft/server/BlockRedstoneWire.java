...
public class BlockRedstoneWire extends Block
{
  ...
  private Set b = new java.util.HashSet();
  ...
  public boolean canPlace(World world, int i, int j, int k) {
    return (World.a(world, i, j - 1, k)) || (world.getType(i, j - 1, k) == Blocks.GLOWSTONE);
  }
  ...
  private void a(World world, int i, int j, int k, int l, int i1, int j1) {
    ...
    byte b0 = 0;
    int l1 = getPower(world, l, i1, j1, b0);
    ...
    for (int k2 = 0; k2 < 4; k2++) {
      ...
      if ((l2 != l) || (i3 != j1)) {
        j2 = getPower(world, l2, j, i3, j2);
      }
      
      if ((world.getType(l2, j, i3).r()) && (!world.getType(i, j + 1, k).r())) {
        if (((l2 != l) || (i3 != j1)) && (j >= i1)) {
          j2 = getPower(world, l2, j + 1, i3, j2);
        }
  ...
  public int c(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    return !this.a ? 0 : b(iblockaccess, i, j, k, l);
  }
  ...
  public int b(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    ...
    return (l == 5) && (flag1) && (!flag2) && (!flag3) ? i1 : (l == 4) && (flag) && (!flag2) && (!flag3) ? i1 : (l == 3) && (flag3) && (!flag) && (!flag1) ? i1 : (l == 2) && (flag2) && (!flag) && (!flag1) ? i1 : (!flag2) && (!flag1) && (!flag) && (!flag3) && (l >= 2) && (l <= 5) ? i1 : 0;
  }
  ...
  public static boolean f(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    ...
    if (block == Blocks.REDSTONE_WIRE)
      return true;
    if (!Blocks.DIODE_OFF.e(block)) {
      return (block.isPowerSource()) && (l != -1);
    }
    int i1 = iblockaccess.getData(i, j, k);
    
    return (l == (i1 & 0x3)) || (l == Direction.f[(i1 & 0x3)]);
  }
  ...
  public static boolean g(IBlockAccess iblockaccess, int i, int j, int k, int l)
  {
    if (f(iblockaccess, i, j, k, l))
      return true;
    if (iblockaccess.getType(i, j, k) == Blocks.DIODE_ON) {
      int i1 = iblockaccess.getData(i, j, k);
