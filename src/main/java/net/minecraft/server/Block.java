...
public class Block
{
  ...
  public void a(World world, int i, int j, int k, AxisAlignedBB axisalignedbb, List list, Entity entity) {
    AxisAlignedBB axisalignedbb1 = a(world, i, j, k);
  ...
  public AxisAlignedBB a(World world, int i, int j, int k) {
    return AxisAlignedBB.a(i + this.minX, j + this.minY, k + this.minZ, i + this.maxX, j + this.maxY, k + this.maxZ);
  }
  ...
  public void onPlace(World world, int i, int j, int k) {
    org.spigotmc.AsyncCatcher.catchOp("block onPlace");
  }
  ...
  public float getDamage(EntityHuman entityhuman, World world, int i, int j, int k) {
    float f = f(world, i, j, k);
    
    return !entityhuman.a(this) ? entityhuman.a(this, false) / f / 100.0F : f < 0.0F ? 0.0F : entityhuman.a(this, true) / f / 30.0F;
  }
  ...
  public int getDropData(World world, int i, int j, int k) {
    return getDropData(world.getData(i, j, k));
  }
