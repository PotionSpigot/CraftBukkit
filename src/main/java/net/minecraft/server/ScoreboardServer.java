...
public class ScoreboardServer extends Scoreboard
{
  ...
  private final Set b = new java.util.HashSet();
  ...
  public void handleScoreChanged(ScoreboardScore scoreboardscore) {
    ...
    if (this.b.contains(scoreboardscore.getObjective())) {
      sendAll(new PacketPlayOutScoreboardScore(scoreboardscore, 0));
    }
  ...
  public boolean addPlayerToTeam(String s, String s1) {
    if (super.addPlayerToTeam(s, s1)) {
      ...
      sendAll(new PacketPlayOutScoreboardTeam(scoreboardteam, java.util.Arrays.asList(new String[] { s }), 3));
      b();
      return true;
    }
    return false;
  ...
  public void removePlayerFromTeam(String s, ScoreboardTeam scoreboardteam)
  {
    ...
    sendAll(new PacketPlayOutScoreboardTeam(scoreboardteam, java.util.Arrays.asList(new String[] { s }), 4));
    b();
  }
