...
public class LoginListener implements PacketLoginInListener
{
  ...
  public void c()
  {
    ...
    if (s != null)
    {
      ...
      if (this.networkManager.getVersion() >= 27)
      {
        this.networkManager.handle(new org.spigotmc.ProtocolInjector.PacketLoginCompression(256), new GenericFutureListener[] { new GenericFutureListener()
        {
          public void operationComplete(Future future)
            throws Exception
          {
            LoginListener.this.networkManager.enableCompression();
          }
        } });
      }
  ...
  public void a(PacketLoginInEncryptionBegin packetlogininencryptionbegin) {
    ...
    if (!java.util.Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
