...
public class EntityExperienceOrb extends Entity
{
  ...
  public void h() {
    ...
    j(this.locX, (this.boundingBox.b + this.boundingBox.e) / 2.0D, this.locZ);
    double d0 = 8.0D;
    ...
    {
      EntityTargetEvent event = CraftEventFactory.callEntityTargetEvent(this, this.targetPlayer, org.bukkit.event.entity.EntityTargetEvent.TargetReason.CLOSEST_PLAYER);
